...
export function Details() {
  return (
    <section className="flex flex-col lg:flex-row items-center lg:justify-center xl:justify-between">
      <div className="w-[350px] sm:w-[550px] md:my-[30px] h-[240px] sm:h-[406px] flex flex-col justify-between items-center lg:items-start text-center lg:text-start">
        <h2 className="font-semibold text-[32px] sm:text-[48px] leading-[130%] md:leading-[160%]">Conquiste a riqueza que sempre desejou.</h2>
