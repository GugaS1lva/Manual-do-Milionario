...
export function Details() {
  return (
    <section className="flex items-center justify-between">
      <div className="w-[550px] h-[406px] flex flex-col justify-between items-start">
        <h2 className="font-semibold text-[48px] leading-[160%]">Conquiste a riqueza que sempre desejou.</h2>

        <p className="text-[18px] text-white/70 max-w-[500px]">Este curso intensivo é composto por mais de 30 horas de conteúdo, dividido em módulos acessíveis e fáceis de acompanhar. Você terá a flexibilidade de estudar no seu próprio ritmo, adaptando-se à sua agenda.</p>

        <button className="w-[170.3px] h-[64px] rounded-[10px] text-[18px] font-medium bg-[#FF9900] hover:bg-white text-black transition duration-75">Saiba Mais</button>
      </div>

      <ul className="flex flex-col gap-y-[36px]">
