...
export function Plans() {
  return (
    <section className="-mt-[200px] sm:mt-[50px] lg:mt-[142px] mb-0 sm:mb-[100px]">
      <ul className="flex flex-col lg:flex-row items-center lg:items-start justify-center gap-[32px] scale-75 sm:scale-100">
